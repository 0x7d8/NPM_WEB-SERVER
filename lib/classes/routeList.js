...
module.exports = class routeList {
    ...
    set(/** The Request Type */ type, /** The Path on which this will be available */ path, /** The Async Code to run on a Request */ code) {
    ...
    static(/** The Path to serve the Files on */ path, /** The Location of the Folder to load from */ folder, options) {
        const preload = (options === null || options === void 0 ? void 0 : options.preload) || false;
        const remHTML = (options === null || options === void 0 ? void 0 : options.remHTML) || false;
        const addTypes = (options === null || options === void 0 ? void 0 : options.addTypes) || true;
    ...
    load(/** The Location of the Folder to load from */ folder) {
