  ...
  ctx.events.once("startRequest", async () => {
    ...
    let ctr = {
      ...
      printStream(stream, options = {}) {
        var _a2, _b2;
        const endRequest = (_a2 = options == null ? void 0 : options.endRequest) != null ? _a2 : true;
        const destroyAbort = (_b2 = options == null ? void 0 : options.destroyAbort) != null ? _b2 : true;
        ctx.waiting = true;
