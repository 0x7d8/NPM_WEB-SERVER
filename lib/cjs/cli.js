...
if (args.includes("-v") || args.includes("--version")) {
  ...
  console.log(`v${import_package.default.version}`);
  ...
  if (refreshInterval !== -1)
    setInterval(() => {
      ...
      const routes2 = new import__.default.routeList();
  ...
  const routes = new import__.default.routeList();
  ...
  const controller = import__.default.initialize(webserverOptions);
