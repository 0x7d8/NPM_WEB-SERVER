...
interface Ctr<Body = any> extends HTTPRequestContext<Custom, Body> {}
interface CtrFile<Body = any> extends RouteFile<Custom, Body> {}
...
Function File
```ts
import { HTTPRequestContext, RouteFile } from "rjweb-server/interfaces"
