...
type HTTPRatelimit<Context extends Record<any, any>, Middlewares extends MiddlewareInitted[]> = (ctr: MergeObjects<[ HttpRequest<Context, unknown>, InstanceType<Middlewares[number]['data']['classModifications']['http']> ]>) => RealAny
...
type WSMessageRatelimit<Context extends Record<any, any>, Middlewares extends MiddlewareInitted[]> = (ctr: MergeObjects<[ WsMessage<Context, unknown>, InstanceType<Middlewares[number]['data']['classModifications']['wsMessage']> ]>) => RealAny
