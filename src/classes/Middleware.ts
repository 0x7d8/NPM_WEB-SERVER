...
> = {
	...
	config: Config
	callbacks: {
		load?(config: any, server: any, context: any): RealAny
		httpRequest?(config: any, server: any, context: any, ctr: any, end: any): RealAny
		wsOpen?(config: any, server: any, context: any, ctr: any, end: any): RealAny
		wsMessage?(config: any, server: any, context: any, ctr: any, end: any): RealAny
		wsClose?(config: any, server: any, context: any, ctr: any, end: any): RealAny
	}

	finishCallbacks: {
		httpRequest?(config: any, server: any, context: any, ctr: any, ms: number): RealAny
		wsOpen?(config: any, server: any, context: any, ctr: any, ms: number): RealAny
		wsMessage?(config: any, server: any, context: any, ctr: any, ms: number): RealAny
		wsClose?(config: any, server: any, context: any, ctr: any, ms: number): RealAny
	}
}
